...
const MATRIZ_ARTICULACION: Record<"7mo" | "9no", { titulo: string; situacionProblema: string; items: ItemArticulacion[] }> = {
  "9no": {
    ...
    items: [
      {
        subarea: "Subárea 1: Sistemas Automatizados y Arquitectura de Control",
        indicadorCognitivo: "Ind 1 & Ind 2. Microcontrolador, Sensores y Actuadores",
        reactivosRelacionados: "Reactivos 1 y 2",
      ...
      },
      {
        ...
        reactivosRelacionados: "Reactivo 4",
      ...
      },
      {
        ...
        reactivosRelacionados: "Reactivo 3",
      ...
      {
        subarea: "Subárea 2: Pensamiento Computacional y Lógica Condicional",
        indicadorCognitivo: "Ind 5, 6, 7 & 8. Lógica Condicional y Umbrales",
        reactivosRelacionados: "Reactivos 5, 6, 7 y 8",
      ...
      {
        subarea: "Subárea 3: Depuración, Conectividad y Datos",
        indicadorCognitivo: "Ind 9. Detección y Depuración de Fallas",
        reactivosRelacionados: "Reactivo 9",
      ...
      },
      {
        ...
        reactivosRelacionados: "Reactivo 10",
  ...
  "7mo": {
    ...
    situacionProblema: "«CyberQuest: Ciudadanía Digital y Pensamiento Lógico»",
    items: [
      {
        subarea: "Subárea 1: Ciudadanía Digital e Internet Seguro",
        indicadorCognitivo: "Ind 1 & Ind 2. Identidad y Contraseñas Robustas",
        reactivosRelacionados: "Reactivos 1 y 2",
        saberTeorico: "Reconoce prácticas de ciberseguridad, phishing y protección de credenciales.",
        practicaPsicomotriz: "P4. Motricidad Fina y Destreza Digital",
        saberHacer: "Manejo ágil del teclado y comandos para ingreso seguro de contraseñas.",
        evidenciaEsperada: "Logrado (L): Escritura fluida de caracteres especiales y símbolos.",
        decisionPedagogica: "Actividades de mecanografía y simulacros de detección de trampas digitales.",
      },
      {
        subarea: "Subárea 3: Pensamiento Lógico y Secuencias",
        indicadorCognitivo: "Ind 5 & Ind 6. Secuencias y Algoritmos Cotidianos",
        reactivosRelacionados: "Reactivos 5 y 6",
        saberTeorico: "Ordena secuencias lógicas paso a paso para resolver laberintos.",
        practicaPsicomotriz: "P1. Orientación Espacial en Cuadrícula",
        saberHacer: "Desplazamiento del avatar en cuadrícula 4x4 aplicando lateralidad.",
