...
const CLIENT_JS_PATH = path.join(process.cwd(), "scripts", "escaner_client.js");
...
const clientScriptSource = fs.existsSync(CLIENT_JS_PATH)
  ? fs.readFileSync(CLIENT_JS_PATH, "utf8")
  : "";
...
const fullHtml = headPart + html5QrcodeSource + htmlMiddle + clientScriptSource + tailPart;
