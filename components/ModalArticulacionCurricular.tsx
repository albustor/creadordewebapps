...
const MATRIZ_ARTICULACION: Record<"7mo" | "9no", { titulo: string; situacionProblema: string; items: ItemArticulacion[] }> = {
  ...
  "7mo": {
    ...
    items: [
      {
        subarea: "Grupo de criterios asociados 1: Fundamentos de Computación, Cuidado del Equipo y Hardware",
      ...
      {
        subarea: "Grupo de criterios asociados 3: Lógica Proposicional, Algoritmia y Control",
